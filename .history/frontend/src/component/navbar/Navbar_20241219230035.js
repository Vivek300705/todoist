    ...
    <div className="bg-gray-800 text-white">
      <nav className="flex items-center px-6 py-4">
        ...
        <button
          ...
          className="block md:hidden text-white ml-auto focus:outline-none"
        >
          {menuOpen ? (
            <svg
              className="w-6 h-6"
        ...
        <div
          ...
          } md:flex md:items-center md:space-x-4 ml-auto absolute md:static top-16 left-0 w-full bg-gray-800 md:bg-transparent z-10`}
        >
          <a
            href="#"
