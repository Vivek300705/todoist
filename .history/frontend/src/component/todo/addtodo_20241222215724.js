...
const AddTodo = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col"
      ...
      <div className="container mx-auto flex flex-row gap-6 py-4 px-1">
        {/* Todo List Box */}
        <div className="flex-1  bg-white p- rounded-md shadow-md">
        ...
        {/* Todo Form Box */}
        <div className="flex-1 max-h-fit bg-white p-6 rounded-md shadow-md">
