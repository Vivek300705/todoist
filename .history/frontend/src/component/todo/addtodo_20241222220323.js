  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto flex flex-row gap-6 py-4 px-2">
        {/* Todo List Box */}
        <div className="flex-1 bg-white p-6 rounded-md shadow-md bg-opacity-30">
          <h2 className="text-xl font-medium mb-4">Todo List</h2>
          <div className="flex flex-col justify-center gap-4">
            {todos.map((todo) => (
              <div
                key={todo._id}
                className="flex flex-col justify-center p-4 bg-blue-100 rounded-md shadow-md"
                style={{
                  minWidth: "250px", // Adjust the min-width as needed
                  maxWidth: "400px", // Adjust the max-width as needed
                }}
              >
                <div className="flex items-center jsu gap-2">
