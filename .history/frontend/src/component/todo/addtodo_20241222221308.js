...
const AddTodo = () => {
  ...
  style={{
    minWidth: "250px", // You can adjust this based on your layout
    maxWidth: "350px", // You can limit the max-width to keep tasks compact
  }}
>
  <div className="flex items-center justify-between gap-2">
    ...
    <div
      className={`${
        todo.completed ? "line-through text-gray-500" : "text-sm" // Set text size to 'sm' for medium tasks
      }`}
    >
      <strong className="text-base">{todo.heading}</strong>: {todo.text}
    </div>
  </div>
