...
const AddTodo = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center relative"
      ...
      <div className="relative z-10 bg-white p-8 rounded-lg shadow-xl max-w-2xl w-full mx-4 bg-opacity-80">
        <h2 className="text-3xl font-bold mb-8 text-center">Todo List</h2>
