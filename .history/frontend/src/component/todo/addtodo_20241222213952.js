          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              {todos.map((todo) => (
                <div
                  key={todo._id}
                  className="flex flex-col justify-between items-center p-4 bg-blue-100 rounded-md shadow-md min-w-[250px] max-w-[400px] w-auto"
                  style={{
                    minWidth: "250px", // You can adjust this width based on your design
                    maxWidth: "400px", // You can also set a maximum width
                    flexGrow: 1, // Allow it to expand and contract based on content
                  }}
                >
                  <div>
