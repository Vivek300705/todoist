...
function Home() {
  ...
  return (
    <div className="text-center h-screen flex flex-col justify-center items-center bg-gradient-to-bl from-[#4f46e5] via-[#4338ca] to-[#831843]">
      <div className="text-2xl   p-8 bg-white text-slate-300rounded-lg bg-opacity-10 shadow-2xl  bg-transparent  ">
