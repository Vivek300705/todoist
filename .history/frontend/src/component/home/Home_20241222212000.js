...
function Home() {
  ...
  return (
    <div className="text-center h-screen flex flex-col justify-center items-center bg-[https://img.freepik.com/free-photo/abstract-luxury-gradient-blue-background-smooth-dark-blue-with-black-vignette-studio-banner_1258-56228.jpg]">
      <div className="text-2xl   p-8 bg-white text-white rounded-lg shadow-2xl  bg-transparent  ">
