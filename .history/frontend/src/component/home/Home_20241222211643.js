...
function Home() {
  ...
  return (
    <div className="text-center h-screen flex flex-col justify-center items-center bg-orange-400">
      <div className="text-2xl   p-8 bg-white text-slate-300 rounded-lg bg-opacity- shadow-2xl  bg-transparent  ">
