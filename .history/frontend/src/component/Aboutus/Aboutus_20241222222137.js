  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto flex flex-col items-center justify-center py-8 px-4">
        <div className="bg-white p-8 rounded-md shadow-md bg-opacity-30 ">
          ...
          <div className="text-center">
            <p className="mb-4">I would love to hear from you! If you have any suggestions or feedback, feel free to send them my way.</p>
            <form
